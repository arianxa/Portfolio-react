export const Contact = () => {
  return (
    <section id="contact" className="py-24 bg-fondo-claro">
         <h2 className=" text-5xl md:text-6xl font-bold mb-4 text-texto text-center">
             Contacto
            </h2>
      <div className="p-4 ">
        
        <div className="grid lg:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-4xl max-lg:max-w-2xl bg-white rounded-md shadow-lg">
          <div>
              ...
              <ul className="mt-4">
                <li className="flex items-center">
                  ...
                  <a href="mailto:info@example.com" className="text-sm ml-4">
                    ...
                    <span className="text-blue-600 font-medium">info@example.com</span>
                  </a>
                </li>
              </ul>
            </div>
              ...
              <ul className="flex mt-4 space-x-4">
                <li className="bg-gray-200 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="#000" viewBox="0 0 24 24">
                ...
                <li className="bg-gray-200 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="#000" viewBox="0 0 511 512">
